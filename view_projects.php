    ...
    <div class="wrapper d-flex align-items-stretch">
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components mb-5">
                ...
                <li>
                    <a href="view_projects.php"><span class="home"></span> View Project Details</a>
                </li>
        ...
        <div id="content" class="p-4 p-md-5 pt-5">
            ...
            <div class="table-container" id="table1">
                ...
                <!-- MySQL query to select specific fields from the "project" table -->
                <?php
                    $sql = "SELECT project_id, project_name, head, budget, due_date FROM project";
